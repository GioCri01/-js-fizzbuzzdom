...
const primoDividendo = 3 ;

const secondoDividendo = 5 ;

for( let i=1; i <= limit;i++){
    const element = document.createElement("div");
    element.className = "box";
    
    if(i % primoDividendo === 0 && i % secondoDividendo === 0 ){
    ...
    }else if(i % secondoDividendo === 0){
        element.append("Buzz");
        element.classList.add("box-yellow");
        container.append(element);

        
    }else if(i % primoDividendo === 0){
        element.append("Fizz");
        element.classList.add("box-brown");
        container.append(element);
    }
    else{
        element.append(i);
